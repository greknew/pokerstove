 ...
 * $Id: OmahaFiveHighHandEvaluator.h 2649 2012-06-30 04:53:24Z prock $
 */
#ifndef PEVAL_OMAHAFIVEHIGHHANDEVALUATOR_H_
#define PEVAL_OMAHAFIVEHIGHHANDEVALUATOR_H_
...
{
/**
 * A specialized hand evaluator for five card omaha.  Not as slow.
 */
class OmahaFiveHighHandEvaluator : public PokerHandEvaluator
{
public:
    static const int NUM_OMAHA_POCKET = 5;
...
#endif  // PEVAL_OMAHAFIVEHIGHHANDEVALUATOR_H_
